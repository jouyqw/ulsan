...
:::table
질문 | 답변
특수공무집행방해는 어떤 죄인가요? | 위험한 물건을 휴대하거나 다중의 위력으로 공무집행을 방해한 경우입니다.
일반 공무집행방해와 다른가요? | 법정형이 더 무겁습니다.
술에 취해 기억이 없으면요? | 기억 여부와 별개로 행위와 고의로 판단합니다.
경찰관과 합의가 되나요? | 피해 회복과 사과는 양형에 고려될 수 있습니다.
실형 가능성이 큰가요? | 사안에 따라 다르며 폭력 정도와 피해가 중요합니다.
무엇을 준비해야 하나요? | 현장 영상 확인, 사실관계 정리, 재발 방지 계획입니다.
:::
...
강성수 변호사는 사건 초기 상담부터 경찰 조사, 합의, 재판 대응까지 변호사가 직접 확인합니다.
