...
강성수 변호사는 두 사건의 관련성과 증거 중복성을 정리해 대법원에 병합심리를 신청했고, 결국 **하나의 법원에서 함께 심리**하도록 결정을 받아냈습니다.
:::
...
:::table
질문 | 답변
재판이 두 곳에서 진행되면 불리한가요? | 형이 따로 정해져 전체 형량이 무거워질 수 있습니다.
병합심리는 어떻게 신청하나요? | 관할 지정이나 이송 신청 등의 절차를 통해 검토할 수 있습니다.
병합되면 형이 줄어드나요? | 한꺼번에 판단되어 전체 형량이 조정될 여지가 생깁니다.
언제 신청해야 하나요? | 빠를수록 좋습니다. 한쪽이 선고되면 병합이 어려워집니다.
사건이 여러 개면 무조건 병합되나요? | 아닙니다. 관할과 진행 정도에 따라 결정됩니다.
변호인이 꼭 필요한가요? | 절차가 복잡하고 시기가 중요해 사전 검토가 필요합니다.
:::
...
강성수 변호사가 직접 상담하고, 기록 검토부터 병합심리 신청, 재판 대응까지 직접 진행합니다.
