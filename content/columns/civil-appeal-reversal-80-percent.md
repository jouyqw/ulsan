...
강성수 변호사는 항소심에서 계약 구조와 증거의 의미를 다시 정리했습니다.
...
:::table
질문 | 답변
1심에서 졌는데 항소하면 바뀌나요? | 1심에서 다투지 못한 증거나 새로운 주장이 있으면 결과가 달라질 수 있습니다.
민사 항소 기간은 얼마인가요? | 판결문을 송달받은 날부터 2주 이내입니다.
항소심은 처음부터 다시 하나요? | 1심 기록을 이어받아 진행하며 부족한 부분을 보충하는 구조입니다.
새로운 증거를 낼 수 있나요? | 제출할 수 있으나 늦어질수록 받아들여지기 어려워집니다.
비용은 얼마나 더 드나요? | 인지대와 송달료가 추가되며 청구금액에 따라 달라집니다.
이기면 돈은 바로 받나요? | 아닙니다. 확정 후 강제집행 절차가 따로 필요합니다.
:::
...
강성수 변호사가 직접 1심 판결문과 증거기록을 검토하고, 항소심에서 다르게 볼 수 있는 쟁점을 찾습니다.
