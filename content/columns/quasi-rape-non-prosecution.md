...
image: "assets/images/success/quasi-rape-non-prosecution-column.webp"
...
하지만 강성수 변호사는 진술 싸움에만 머물지 않았습니다.
...
:::table
질문 | 답변
카톡이 삭제되면 불리한가요? | 반드시 그렇지는 않으며 복원이나 다른 자료로 다툴 수 있습니다.
준강간은 무엇이 쟁점인가요? | 항거불능 상태였는지와 그에 대한 인식이 핵심 쟁점입니다.
음주 상태였으면 무조건 성립하나요? | 아닙니다. 당시 상태와 정황을 종합해 판단합니다.
불송치는 어떤 의미인가요? | 경찰 단계에서 혐의가 인정되지 않아 검찰에 넘기지 않는 처분입니다.
증거보전은 언제 하나요? | 자료가 사라질 우려가 있으면 초기에 신청을 검토해야 합니다.
조사 전에 무엇을 해야 하나요? | 남아 있는 대화와 정황을 시간순으로 정리해야 합니다.
:::
...
강성수 변호사가 직접 상담하고, CCTV 확보와 경찰 조사 대응, 변호인 의견서 작성까지 직접 검토합니다.
