...
하지만 강성수 변호사는 범행 경위, 반성 태도, 재범 방지 계획을 정리해 **징역 8개월, 집행유예 2년**을 이끌어냈습니다.
:::
...
:::table
질문 | 답변
등급미필 게임물 제공도 처벌되나요? | 게임산업법 위반으로 처벌 대상이 됩니다.
환전을 하면 더 무거워지나요? | 환전이 확인되면 사행성이 인정되어 무겁게 평가됩니다.
종업원도 처벌되나요? | 가담 정도에 따라 처벌될 수 있습니다.
수익금은 어떻게 되나요? | 범죄수익으로 추징 대상이 될 수 있습니다.
초범이면 벌금인가요? | 규모와 기간에 따라 달라지며 실형이 선고되기도 합니다.
무엇부터 정리해야 하나요? | 운영 기간, 규모, 본인의 역할을 정확히 확인해야 합니다.
:::
...
강성수 변호사가 직접 상담하고, 수사기록 분석부터 양형자료 준비, 재판 변론까지 직접 진행합니다.
