...
하지만 강성수 변호사는 재범 방지 구조와 양형자료를 입체적으로 정리했고, 최종적으로 **벌금 400만 원**을 이끌어냈습니다.
:::
...
:::table
질문 | 답변
음주 전과가 많으면 무조건 실형인가요? | 위험이 크지만 사안과 양형자료에 따라 달라질 수 있습니다.
검찰이 실형을 구형하면 끝인가요? | 구형은 의견일 뿐 법원이 다시 판단합니다.
어떤 자료가 도움이 되나요? | 치료·상담 이력, 차량 처분, 생활 계획 등 재범 차단 자료입니다.
면허는 어떻게 되나요? | 형사와 별개로 취소 처분이 진행되며 결격기간이 적용됩니다.
재범 가중은 언제 적용되나요? | 일정 기간 내 위반 전력이 있는 경우 가중 규정이 적용됩니다.
무엇부터 해야 하나요? | 형사와 행정 두 절차의 기한을 먼저 확인해야 합니다.
:::
...
강성수 변호사가 직접 상담하고, 사건 기록 검토부터 재범 방지 자료, 법정 변론까지 직접 진행합니다.
