...
실형 가능성이 매우 높았지만, 강성수 변호사는 피해 회복 과정과 재범 방지 자료를 정리해 **벌금 1,000만 원**을 이끌어냈습니다.
:::
...
:::table
질문 | 답변
집행유예 중 무면허 사고면 실형인가요? | 실형 위험이 큰 사안이지만 대응에 따라 달라질 수 있습니다.
무면허와 음주가 겹치면 어떻게 되나요? | 각 위반이 함께 평가되어 형이 무거워집니다.
피해자와 합의하면 도움이 되나요? | 피해 회복은 양형에서 중요한 요소입니다.
보험 처리만 해도 되나요? | 보험 처리와 별개로 형사 절차는 계속 진행됩니다.
면허는 어떻게 되나요? | 형사와 별개로 행정처분이 진행되며 결격기간이 적용됩니다.
무엇부터 준비해야 하나요? | 사고 경위 정리, 피해 회복, 재범 방지 계획입니다.
:::
...
강성수 변호사가 직접 상담하고, 기록 검토부터 서면 작성, 재판 변론까지 직접 진행합니다.
