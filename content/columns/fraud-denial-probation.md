...
강성수 변호사는 전략을 현실적으로 바꾸어 **피해 회복, 합의, 선처 탄원**을 중심으로 대응했고, 최종적으로 **집행유예**를 이끌어냈습니다.
:::
...
:::table
질문 | 답변
혐의를 부인하면 불리한가요? | 부인 자체가 불리한 것은 아니지만 객관 자료와 어긋나면 신빙성을 잃습니다.
중간에 인정으로 바꿔도 되나요? | 가능하지만 늦어질수록 반성의 진정성이 약하게 평가됩니다.
피해 회복이 중요한가요? | 사기 사건에서 피해 변제는 양형에 가장 크게 작용합니다.
편취 의사는 어떻게 판단하나요? | 자금 사용처, 변제 능력, 사후 태도를 종합해 봅니다.
합의가 안 되면 어떻게 하나요? | 형사공탁이나 변제 계획으로 회복 의사를 표시할 수 있습니다.
처음에 무엇을 정해야 하나요? | 인정할 부분과 다툴 부분을 조사 전에 구분해야 합니다.
:::
...
강성수 변호사는 사건 기록 검토, 피해자 합의, 재판 대응까지 변호사가 직접 진행합니다.
