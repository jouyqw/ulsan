...
image: "assets/images/success/lease-fraud-forgery-probation-column.webp"
...
하지만 강성수 변호사는 피해 회복, 범행 경위, 재범 방지 자료를 체계적으로 정리했습니다.
...
:::table
질문 | 답변
사문서위조는 어떤 경우에 성립하나요? | 권한 없이 타인 명의 문서를 만들거나 내용을 바꾼 경우입니다.
사기와 함께 기소되면 무거워지나요? | 두 죄가 함께 평가되어 형이 무거워질 수 있습니다.
대출금을 갚으면 도움이 되나요? | 피해 회복은 양형에서 중요한 요소로 고려됩니다.
시키는 대로 했다고 하면 되나요? | 가담 정도가 참작될 수 있으나 책임이 사라지지는 않습니다.
금융기관이 피해자면 합의가 되나요? | 어려운 경우가 많아 변제 계획과 공탁을 함께 검토합니다.
초기에 무엇이 중요한가요? | 문서 작성 경위와 관여 범위를 정확히 정리하는 것입니다.
:::
...
강성수 변호사가 직접 상담하고, 사건 기록 검토부터 서면 작성, 조사 대응, 재판 변론까지 직접 진행합니다.
