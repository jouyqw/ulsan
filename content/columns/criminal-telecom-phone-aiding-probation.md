...
하지만 강성수 변호사는 의뢰인의 가담 정도가 제한적이었다는 점과 재범 방지 가능성을 정리했습니다.
...
:::table
질문 | 답변
대포폰 개설을 도우면 처벌되나요? | 전기통신사업법 위반 등으로 처벌될 수 있습니다.
몰랐다고 하면 인정되나요? | 대화 내용과 대가 수수 정황으로 인식 여부가 판단됩니다.
방조여도 처벌이 무거운가요? | 가담 정도에 따라 다르지만 조직적 범행에 연결되면 무거워집니다.
보이스피싱과 연결되면 어떻게 되나요? | 피해 규모가 크면 훨씬 무겁게 평가됩니다.
받은 돈을 돌려주면 도움이 되나요? | 이익 반환과 피해 회복은 양형에 유리하게 고려됩니다.
초범이면 집행유예가 되나요? | 보장되지 않으며 가담 정도와 피해 회복이 함께 평가됩니다.
:::
...
강성수 변호사가 직접 상담하고, 수사기록 분석부터 법리 구성, 재판 변론까지 직접 진행합니다.
