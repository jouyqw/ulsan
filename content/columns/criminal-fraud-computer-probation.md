...
하지만 강성수 변호사는 경합범 법리와 피해 회복 자료를 정리해 실형 위험을 낮췄습니다.
...
:::table
질문 | 답변
집행유예 기간 중 범행이면 실형인가요? | 가능성이 높아지지만 사안과 양형자료에 따라 달라질 수 있습니다.
피해자가 여러 명이면 어떻게 되나요? | 피해 규모와 반복성이 무겁게 평가되므로 피해 회복이 중요합니다.
합의가 안 되면 방법이 없나요? | 형사공탁이나 변제 계획으로 회복 의사를 표시할 수 있습니다.
컴퓨터등사용사기는 일반 사기와 다른가요? | 정보처리장치를 이용한 경우에 적용되는 별도의 죄명입니다.
수사 초기에 무엇을 해야 하나요? | 인정할 부분과 다툴 부분을 먼저 정리한 뒤 조사에 응해야 합니다.
변호인 선임 시점이 중요한가요? | 첫 조사 전이 가장 좋습니다. 초기 진술이 이후 기록의 기준이 됩니다.
:::
...
강성수 변호사가 직접 상담하고, 법리 검토부터 피해자 합의, 재판 변론까지 직접 진행합니다.
