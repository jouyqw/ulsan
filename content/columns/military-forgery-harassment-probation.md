...
image: "assets/images/success/military-forgery-harassment-probation-column.webp"
...
하지만 강성수 변호사는 섣부른 공탁이나 형식적인 반성문에 머물지 않았습니다.
...
:::table
질문 | 답변
군 사건도 민간 변호사가 맡나요? | 선임할 수 있으며 군사법원 절차에 맞춰 진행합니다.
피해자가 여러 명이면 어떻게 되나요? | 피해 규모가 무겁게 평가되므로 개별 피해 회복이 중요합니다.
부대 내 처분과 형사처벌은 별개인가요? | 징계와 형사절차는 별도로 진행됩니다.
합의가 가능한가요? | 가능하며 피해자별로 진행 상황을 정리해야 합니다.
전역 후에도 진행되나요? | 사건에 따라 관할이 달라질 수 있어 확인이 필요합니다.
무엇부터 준비해야 하나요? | 사실관계 정리와 피해 회복 계획입니다.
:::
...
강성수 변호사가 직접 사건을 검토하고, 필요한 자료와 대응 방향을 정리합니다.
