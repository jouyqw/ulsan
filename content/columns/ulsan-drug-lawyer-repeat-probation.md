...
하지만 강성수 변호사는 사건을 단순한 반복 범행으로만 보이게 두지 않았습니다.
...
:::table
질문 | 답변
재판 중 재범이면 구속되나요? | 구속 위험이 매우 크며 즉시 대응이 필요합니다.
구속되면 되돌릴 수 있나요? | 구속적부심이나 보석을 검토할 수 있습니다.
치료 자료가 정말 도움이 되나요? | 재범 위험을 낮추는 핵심 자료로 평가됩니다.
어떤 검사를 받아야 하나요? | 소변·모발 검사와 중독 관련 전문 진료가 일반적입니다.
가족이 할 수 있는 일은요? | 구체적인 보호계획과 생활환경 개선 자료를 준비할 수 있습니다.
언제 상담해야 하나요? | 재범 사실을 인지한 즉시가 가장 좋습니다.
:::
