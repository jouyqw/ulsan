...
for (const file of pages) {
  ...
  if (/data-live-consults/i.test(html) && (!/CONSULTATION EXAMPLES/i.test(html) || !/data-nosnippet/i.test(html))) {
    errors.push(`${fileRel}: automated consultation examples must keep visible example labeling and data-nosnippet guard`);
  }
